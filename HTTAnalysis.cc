...
int main(int argc, char ** argv) {
	...
	// "Asymm" prepares asymmetry histograms for later analysis.
	 if(processName=="Weights" || processName=="PU" || processName=="Asymm" ) myAnalyzers.push_back(new HTTWeightsMaker("HTTWeightsMaker"));
